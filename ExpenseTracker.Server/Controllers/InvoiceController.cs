    ...
    public class InvoiceController : Controller
    {
        ...
        public async Task<IActionResult> CreatePDFAsync([FromQuery] PaginatedQuery paginatedQuery)
        {
            ...
            var globalSettings = new GlobalSettings
            {
                ...
                // Out = $@"D:\itelasoft-thanu\Blazor\Assignment\expense-tracker\ExpenseTracker.Server\wwwroot\pdfs\Invoice_Report_{time}.pdf"
            };
            var objectSettings = new ObjectSettings
            {
                ...
                FooterSettings = { FontName = "Arial", FontSize = 9, Line = true, Center = $"Agreement generated at {time}" }
            };
